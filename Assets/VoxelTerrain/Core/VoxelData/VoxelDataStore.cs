...
namespace Eldemarkki.VoxelTerrain.VoxelData
{
    ...
    public class VoxelDataStore : MonoBehaviour
    {
        ...
        void OnValuesUpdated()
        {
            _chunks = new Dictionary<int3, VoxelDataVolume>();
            _generationJobHandles = new Dictionary<int3, JobHandleWithData<IVoxelDataGenerationJob>>();
            Debug.Log("Voxel Data: Validated");
        ...
        void UpdateValues()
        {
            if (VoxelWorld.MapEditorEventHandler != null)
            {
                Debug.Log("Validating Voxel Data");

                VoxelWorld.MapEditorEventHandler.OnValuesUpdated -= OnValuesUpdated;

                VoxelWorld.MapEditorEventHandler.OnValuesUpdated += OnValuesUpdated;
            }
        }

        private void OnApplicationQuit() //this is the place we want to save player progress
        { 
